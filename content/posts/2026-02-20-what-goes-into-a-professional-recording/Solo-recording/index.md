...
![](solo_recording_pics/equipment_list.png)
...
{{< accordion mode="open" separated=true >}}
  {{< accordionItem title="Edit Locations" open=false >}}
...
{{< accordion mode="open" separated=true >}}
	{{< accordionItem title="Annotated score" open=false >}}
...
<!-- FM:Snippet:End -->
{{< accordion mode="open" separated=true >}}
{{< accordionItem title="Issues that couldn’t be resolved" open=false >}}
...
### The mix session
![](solo_recording_pics/mix_panning.png "A screenshot of the source recording, showing all the tracks labelled for their respective mics, and panned accordingly. Ultimately, I decided not to use the A/B pair, since they didn’t add anything of value to the mix, hence they're muted here.")
...
![](solo_recording_pics/eq2.png "A screenshot of the EQ applied to the ORTF pair.")
...
![](solo_recording_pics/mixer.png "A screenshot of the master mix of the source recording.")
...
![](solo_recording_pics/full_comp.png)
...
![](solo_recording_pics/eq3.png "On my REVERB track I began with an EQ to take out some of the inaudible low end of the reverb. Since the violin is a heavy in the treble/high frequency, I also reduced out some of the high frequencies. This also helped with cutting out some of the breath noise in the reverb, removing it before it ever reaches the reverb.")

![](solo_recording_pics/reverb.png "Next in the FX chain was my artificial reverb, for which I used an impulse-response based reverb plugin called ReaVerb. I chose an impulse response which fit my desired atmosphere the closest, by having a nice long decay of 3.9 seconds, while still maintaining the attack of the close recording. This channel had no dry signal coming through, since that was completely supplied by the Edit track. I also added -18db of gain so that the reverb wasn’t too overpowering at low levels. I ultimately decided on a bass level of +0.27db for the reverb track.")

![](solo_recording_pics/eq1.png "Finally in my FX chain I introduced another EQ just to roll off the high end of the reverb slightly, so that it wasn’t too bright.")
...
![](solo_recording_pics/markers.png)
...
![](solo_recording_pics/pan.png "The stereo image of my EDIT track was a little too wide for my liking, so this was reduced to 49%. I also reduced the volume of some of the takes that I used, so that they matched each other, this has been labelled in my edit table above." )
...
![](solo_recording_pics/edit_points.png "A screenshot showing before and after finishing an edit. ")
